...
const AdminHeader = (props) => {
    ...
    return (
        <header id="admin-header" className="w-100 hero-height-50 position-fixed top-0 start-0 d-flex justify-content-between align-items-center ps-5 pe-4 hero-zindex-50 bg-white">
            <DehazeIcon  
            ...
            {user !== null &&
                <Box component="div">
                    ...
                    >
                        ...
                        {!user.photo &&
                            <Box component="div">{user.email}</Box>
                        }
                    </Box>
                    <Menu
