                ...
                <div className="col-md-8 mb-3">
                  {props.video.poster && (
                    <img
                      src={`${process.env.AWS_FILE_PREFIX}${props.video.poster.imageName}`}
                      alt=""
                      className="hero-width-500 mw-100"
                    />
                  )}
                  {props.video.description && <div className="mt-5">{parse(props.video.description)}</div>}
                </div>
                          ...
                          return (
                            <div className="actor mb-3 d-flex align-items-center" key={index}>
                              <div className="d-flex justify-content-ceter align-items-center hero-width-60 me-2">
                                {actor.currentPhoto && (
                                  <img src={`${process.env.AWS_FILE_PREFIX}${actor.currentPhoto.imageName}`} alt="" />
                                )}
                              </div>
