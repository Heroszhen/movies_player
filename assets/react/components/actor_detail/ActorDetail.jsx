                        ...
                        <>
                            ...
                            <div className="col-md-8 mb-3 pt-5">
                                <section className="mb-5 d-flex justify-content-center align-items-center">
                                    <h5 className={(section === 1 ? 'actived ' : '') + "hero-cursor-pointer hero-color-d3d3d3 hover:hero-color-000000 actived:hero-color-000000 me-3"} onClick={()=>setSection(1)}>Biographie</h5>
                                    <h5 className={(section === 2 ? 'actived ' : '') + "hero-cursor-pointer hero-color-d3d3d3 hover:hero-color-000000 actived:hero-color-000000 ms-3"} onClick={()=>setSection(2)}>Filmographie</h5>
                                </section>
                                {section===1 &&
                                                    ...
                                                    <div className="col-6 col-lg-4" key={index}>
                                                        <div className="text-white hero-bg-color-343a40 rounded ps-1 pe-1">
                                                            ...
                                                            <div className="pt-2 pb-2 text-center">
                                                                ...
                                                                <NavLink to={"/video/" + movie.id} className="btn btn-movify">Regarder</NavLink>
                                                            </div>
                                                        </div>
                                                    </div>
                                                );
